...
app.controller('statsCtrl', function($scope){
  ...
  var updateScores = function() {
    socket.on('scores', function(json) {
      ...
      function updateBackground(div, percent) {
        if (percent === 0) {
      ...
      updateBackground(bg1, percentages.a);
      updateBackground(bg2, percentages.b);
      updateBackground(bg3, percentages.c);
      updateBackground(bg4, percentages.d);
